...
frozen = media.Movie(
    ...
    "winter, fearless Anna (Kristen Bell) joins forces" +
    "with mountaineer Kristoff (Jonathan Groff)" +
    "and his reindeer sidekick to find Anna's sister," +
    "Snow Queen Elsa",
...
fate_furios = media.Movie(
    "Fate and Furious",
    "The Fate of the Furious (alternatively known as" +
    "Fast & Furious 8 and Fast 8, and often stylized as F8)" +
    "is a 2017 American action film directed by F. Gary Gray" +
    "and written by Chris Morgan.",
...
star_trek = media.Movie(
    ...
    "adventure film directed by Justin Lin from a " +
    "screenplay by Simon Pegg and Doug Jung and based on " +
    "the series Star Trek created by Gene Roddenberry",
